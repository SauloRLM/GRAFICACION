function CalculosDeRactangulo(x0, y0, x1, y1, contexto, color) {
    /*
    ...
    */
    ...
    //para pintar rectangulo
    if (x0 < x1) {
        if (y0 < y1) {

            //Horizontales
            for (var x = x0; x <= x1; x++) { //Elpunto inicial debe estármás a la izq.q el final
                //Ecuación de la recta en base a x
                PintarPixel(contexto, x, y0, color); //pintar el sig.punto de la línea Math.round() redondeo de y 
            }

            for (var x = x0; x <= x1; x++) { //Elpunto inicial debe estármás a la izq.q el final
                //Ecuación de la recta en base a x
                PintarPixel(contexto, x, y1, color); //pintar el sig.punto de la línea Math.round() redondeo de y 
            }

            //verticales
            for (var y = y0; y <= y1; y++) { //Elpunto inicial debe estármás a la izq.q el final
                //Ecuación de la recta en base a x
                PintarPixel(contexto, x0, y, color); //pintar el sig.punto de la línea Math.round() redondeo de y 
            }
